...
<html templateref="file:///Users/jmguzman/Downloads/Internet_Services/index.html" xmlns="http://www.w3.org/1999/xhtml"><head>
	<meta name="author" content="Luka Cvrk (www.solucija.com)" />
	<meta http-equiv="content-type" content="text/html;charset=iso-8859-1" />
	<link rel="stylesheet" href="images/style.css" type="text/css" />
	<title>Simon Project</title></head>
	...
	<div class="content">
		<div class="header">
			<div class="top_info">
				<div class="top_info_right">
					Entendiedo la Calidad de la Internet en Latinoamerica
			...
			<div class="logo">
				<h1><a href="#" title="Centralized Internet Services">Projecto<span class="dark">Simon</span></a></h1>
			</div>
		</div>
		...
		<div class="bar">
			<ul>
				...
				<li><a href="#" accesskey="i">Home</a></li>
				<li><a href="#" accesskey="i">Objetivos</a></li>
				<li><a href="#" accesskey="i">Quienes Somos?</a></li>
				<li><a href="#" accesskey="i">Latencia?</a></li>
				<li><a href="#" accesskey="i">Participa</a></li>
				<li><a href="#" accesskey="i">Instituciones</a></li>
		...
		<div class="search_field">
			<form method="post" action="?">
				...
				<p>Busca en la web: <input name="search" class="search" type="text" /> <input value="Search" class="submit" type="submit" /> <a class="grey" href="#">Avanzada</a></p>
				</div>
			</form>
			
			<p>Por favor <a href="#">Ingresa</a> or <a href="#">Registrate</a></p>
		</div>
...
Ut wisi <a href="#">enim ad minim</a> veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. <a href="#">Duis autem</a> vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu.</p>
			</div>
...
Ut wisi <a href="#">enim ad minim</a> veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. <a href="#">Duis autem</a> vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu.<a href="#">Duis autem</a> vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu.</p>
		...
		<div class="footer">
			<p><a href="#">RSS Feed</a> | 
			<a href="#">Contacto</a>  <a href="http://jigsaw.w3.org/css-validator/check/referer">CSS</a> and 
			<a href="http://validator.w3.org/check?uri=referer">XHTML</a><br />
			Comite de Projecto Simon</p>
		</div>
	</div>
</body></html>